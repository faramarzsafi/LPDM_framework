...
class li_et_al(diversity):
    ...
    def compute(self, population) -> float:
        ...
        l = math.sqrt(self.number_of_variables * self.number_of_variables * self.number_of_variables)
        ...
        result = div_total / l / self.number_of_variables
